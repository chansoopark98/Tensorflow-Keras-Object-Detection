...
# TODO(human_detection): Markdown description  that will appear on the catalog page.
_DESCRIPTION = """
...
# TODO(human_detection): BibTeX citation
_CITATION = """
"""


class HumanDetection(tfds.core.GeneratorBasedBuilder):
  """DatasetBuilder for human_detection dataset."""
  ...
  def _split_generators(self, dl_manager: tfds.download.DownloadManager):
    ...
    archive_path = '../experiments/human_data/human_detection.zip'
    extracted_path = dl_manager.extract(archive_path)

    # TODO(cornell_grasp): Returns the Dict[split names, Iterator[Key, Example]]
    return {
        'train': self._generate_examples(img_path=extracted_path/'image', bbox_path=extracted_path/'bbox', label_path=extracted_path/'label')
    }
