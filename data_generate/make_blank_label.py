...
parser.add_argument("--rgb_path",     type=str,   help="raw image path", default='./data_generate/data/rgb/')
parser.add_argument("--mask_path",     type=str,   help="raw image path", default='./data_generate/data/mask/')
parser.add_argument("--obj_mask_path",     type=str,   help="raw image path", default='./data_generate/data/obj_mask/')
