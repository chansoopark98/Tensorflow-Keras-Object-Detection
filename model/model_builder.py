...
def model_build(model_mode, base_model_name, pretrained=True, backbone_trainable=True, image_size=[512, 512], normalizations=[20, 20, 20, -1, -1], num_priors=[6, 6, 6, 4, 4]):
    if model_mode == 'voc':
        classes = 21
