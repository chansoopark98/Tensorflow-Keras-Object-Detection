...
"""
256x256
32  | 8   | 0.789(25)  1.5789(51)
16  | 16  | 3.1578(51) 5.8421(93)
8   | 32  | 11.1(89) 16.2(130)
4   | 64  | 32.4(130) 53.25 (213)
2   | 100 |  71 (142) 88 (176)
1   | 300 | 264

>> TODO
300X300 비율에 맞추는게 나을 듯
1/10         1/5
1/5          1/2.7027
1/2.7027     1/1.85185
1/1.85185    1/1.40845
1/1.40845    1/1.13636
1/ 1.13636   1/ 0.952380952
...
def convert_spec_list():
    ...
    spec_list = [
                Spec(32, 8, BoxSizes(26, 51), [2]),
                Spec(16, 16, BoxSizes(51, 95), [2, 3]),
                Spec(8, 32, BoxSizes(95, 138), [2, 3]),
                Spec(4, 64, BoxSizes(138, 182), [2, 3]),
                Spec(2, 100, BoxSizes(182, 225), [2]),
                # Spec(1, 300, BoxSizes(225, 269), [2])
                ]
    # spec_list = [
