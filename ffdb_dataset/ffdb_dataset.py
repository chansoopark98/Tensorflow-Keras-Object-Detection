...
# TODO(ffdb_dataset): Markdown description  that will appear on the catalog page.
_DESCRIPTION = """
...
# TODO(ffdb_dataset): BibTeX citation
_CITATION = """
"""


class FfdbDataset(tfds.core.GeneratorBasedBuilder):
  """DatasetBuilder for ffdb_dataset dataset."""
  ...
  def _split_generators(self, dl_manager: tfds.download.DownloadManager):
    ...
    archive_path = '../data_generate/data/FFDB/results/ffdb_dataset.zip'
