...
specs = [
            Spec(int(IMAGE_SIZE[0]/16), int(IMAGE_SIZE[0]/32),
                 BoxSizes(int(IMAGE_SIZE[0]*0.15), int(IMAGE_SIZE[0]*0.29)), [2, 3]),  # 0.2
            Spec(int(IMAGE_SIZE[0]/32), int(IMAGE_SIZE[0]/16),
                 BoxSizes(int(IMAGE_SIZE[0]*0.29), int(IMAGE_SIZE[0]*0.43)), [2, 3]),  # 0.37
            Spec(int(IMAGE_SIZE[0]/64), int(IMAGE_SIZE[0]/8),
                 BoxSizes(int(IMAGE_SIZE[0]*0.43), int(IMAGE_SIZE[0]*0.57)), [2, 3]),  # 0.54
            Spec(int(IMAGE_SIZE[0]/128), int(IMAGE_SIZE[0]/4),
                 BoxSizes(int(IMAGE_SIZE[0]*0.57), int(IMAGE_SIZE[0]*0.71)), [2]),  # 0.71
            Spec(int(IMAGE_SIZE[0] / 256), int(IMAGE_SIZE[0]/2),
                 BoxSizes(int(IMAGE_SIZE[0] * 0.71), int(IMAGE_SIZE[0] * 0.85)), [2]) # 0.88 / 0.95
        ]
